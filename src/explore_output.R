...
setwd("C:/Users/gmalagoli/Desktop/stratification_tcga") 
...
tab_input<-read.delim(file="Analysis_GMIEC_simplified_results_maxSAD.txt")
tab_input<-tab_input[-which(tab_input$PAM50.Subtype=="Normal-like"),] #exclude normali samples

tab_input_min<-read.delim(file="Analysis_GMIEC_simplified_results_minSAD.txt")
